...
public class FaceSpot {
	...
	private static final String AppID = "29072980";
	private static final String APIKey = "64XQqGGCKiCIV4aNoy3lj44P";
	private static final String SecretKey = "UOArwv9Xe9DvLBvPQ2DEMnO9HhwnzUcr";
	...
	public static void main(String[] args) throws IOException {
		...
		byte[] img2 = FileToByte(new File(file1));
		*/
		String file1 = "F:/84a60c10ceb46308fb027cbe87561a4.jpg";
		byte[] img2 = FileToByte(new File(file1));
