layui.use(['layer', 'form', 'table', 'ztree', 'laydate', 'admin', 'ax','upload'], function () {
    ...
    MgrUser.initColumn = function () {
        return [[
               ...
               {field: 'email', sort: true, title: '学号'},
    ...
    MgrUser.pingja = function (data) {
    	location='/score/evaluate?tacherId=' + data.userId
    };
